  ...
  return (
    <div>
      ...
      <div className="button-group">
        <button className="custom-btn btn-modify" type="button" onClick={() => moveToModify(tno)}> 수정하기 </button>
        <button className="custom-btn btn-list" type="button" onClick={() => moveToList()}> 목록가기 </button>
      </div>
    </div>
  );
};
